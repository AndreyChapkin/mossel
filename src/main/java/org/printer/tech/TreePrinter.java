...
public class TreePrinter<T> {
    ...
    public String treeToString(T root) {
        ...
        if (treeLines.size() > 0) {
            ...
            for (TreeLine treeLine : treeLines) {
                ...
                output.append(spaces(leftSpaces)).append(treeLine.line).append(spaces(rightSpaces)).append(System.lineSeparator());
            }
        }
